                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../pages/tables/basic-table.html">
                            ...
                            <span class="menu-title">Orde</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('flowers.update' , $flower->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName1"
                                                name="toal_price" placeholder="{{ $flower->totePrice }}$" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Available Guantity</label>
                                            <input type="text" class="form-control" id="exampleInputName1"
                                                name="available_guantity" placeholder="{{$flower->available_guantity}}" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Price</label>
                                            <input type="text" class="form-control" id="exampleInputName1"
                                                name="price" placeholder="{{$flower->Price}}$" required>
                                        </div>
