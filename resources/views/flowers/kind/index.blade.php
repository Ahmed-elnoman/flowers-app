                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Kind Table</h4>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            @foreach ($kind_items as $item)
                                                <tr>
                                                    <td class="py-1">
                                                        {{ $item->id }}
                                                    </td>
                                                    <td> {{ $item->name }} </td>
                                                    <td><img src="{{ asset('Flower/1.PNG') }}" alt=""
                                                            srcset=""></td>
                                                    <td> {{ $item->color }}</td>
                                                    <td> {{ $item->country }} </td>
                                                    <td> ahmed</td>
                                                    <td>
                                                        <div>
                                                            <button class="btn btn-danger"><a href="{{url('destroykind' , $item->id)}}"
                                                                    class="text-light"><i class="mdi mdi-window-close"></i></a></button>
                                                            <button class="btn btn-dark"><a href="{{route('flower_Kind.edit' , $item->id)}}"
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Color of flower </p>
                                    <form class="forms-sample" action="{{ route('flower_Kind.store') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName1"
                                                name="color" placeholder="Read" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Conutry</label>
                                            <input type="text" class="form-control" id="exampleInputName1"
                                                name="country" placeholder="Sudan" required>
                                        </div>
