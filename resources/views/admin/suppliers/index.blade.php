                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="{{route('supplier.index')}}">
                                        Supplier </a></li>
                            </ul>
                        </div>
                    </li>
                                        ...
                                        <tbody>
                                            @foreach ($suppliers as $supplier)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            {{-- <button class="btn btn-danger"><a href="{{url('delete_flower' , $supplier->id)}}"
                                                                    class="text-light"><i class="mdi mdi-window-close"></i></a></button>
                                                            <button class="btn btn-dark"><a href="{{route('flowers.edit' , $supplier->id)}}"
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Supplier </p>
