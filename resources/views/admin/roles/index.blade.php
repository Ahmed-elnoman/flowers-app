                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="justify-end">
                                                                <a href="{{route('role.destroy' , $role->id)}}" class="btn btn-danger  ml-10 bg-green-700 justify-end"><i class="mdi mdi-window-close"></i></a>
                                                                <a href="{{route('role.edit' , $role->id)}}" onsubmit="return confirm('Are your sha')" class="btn btn-dark  ml-10 bg-red-700 justify-end"><i class="mdi mdi-cloud-check"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
