                                    ...
                                    <div class="template-demo">
                                        @if ($permission->roles)
                                            @foreach ($permission->roles as $role_permission)
                                                <a href="{{route('permission.role.removeRole' ,[$permission->id , $role_permission->id ])}}"
                                                    class="btn btn-success btn-rounded btn-fw">{{ $role_permission->name }}</a>
                                            @endforeach
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample"
                                        action="{{ route('permission.assign', $permission->id) }}" method="POST">
                                        @csrf
                                        <div class="form-group">
