                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ url('flowers') }}">Flower</a></li>
                                                    ...
                                                    <td>
                                                        <div class="justify-end">
                                                            <a href="{{ route('permission.destroy', $permission->id) }}"
                                                                class="btn btn-danger  ml-10 bg-green-700 justify-end"><i
                                                                    class="mdi mdi-window-close"></i></a>
                                                            <a href="{{ route('permission.edit', $permission->id) }}"
                                                                onsubmit="return confirm('Are your sha')"
                                                                class="btn btn-dark  ml-10 bg-red-700 justify-end"><i
                                                                    class="mdi mdi-cloud-check"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('permission.store') }}"
                                        method="POST">
                                        @csrf
