                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <div class="template-demo">
                                  <a href="{{route('roles.index')}}" class="btn btn-primary btn-rounded btn-fw">Roles</a>
                                  <a href="{{route('permission.index')}}" class="btn btn-success btn-rounded btn-fw">Permissions</a>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <div class="template-demo">
                                  <a href="{{route('roles.index')}}" class="btn btn-primary btn-rounded btn-fw">Users</a>
                                  <a href="{{route('permission.index')}}" class="btn btn-success btn-rounded btn-fw">Customers</a>
                                  <a href="{{route('supplier.index')}}" class="btn btn-success btn-rounded btn-fw">Supplires</a>
                                </div>
                              </div>
                            </div>
                          </div>
