                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description"> Add class <code>.order</code>
                                    </p>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="{{ route('flowers.store') }}"
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputName1">Flwoer name</label>
                                            {{-- <select name="kind" class="form-control">
                                                @foreach ($kindFlower as $kind)
                                                    <option value="{{$kind->id}}">{{$kind->name}}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputName1"
                                                name="available_guantity" placeholder="900$" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputName1">Delivery name</label>
                                            {{-- <select name="kind" class="form-control">
                                                @foreach ($kindFlower as $kind)
                                                    <option value="{{$kind->id}}">{{$kind->name}}</option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputName1">Delivery Date</label>
                                            <input type="date" class="form-control" id="exampleInputName1"
                                                name="available_guantity" placeholder="900$" required>
                                        </div>
                                        <div class="form-group">
